...
/obj/machinery/computer/shuttle/loneSlaver
	name = "slaver shuttle terminal"
	desc = "The terminal used to control the slaver transport shuttle."
	circuit = /obj/item/circuitboard/computer/loneslaver_shuttle
	icon_screen = "syndishuttle"
	icon_keyboard = "syndie_key"
	light_color = LIGHT_COLOR_RED
	shuttleId = "loneSlaver"
	possible_destinations = "lone_slavers_den;whiteship_lavaland;slaver_custom"
	resistance_flags = INDESTRUCTIBLE | LAVA_PROOF | FIRE_PROOF | ACID_PROOF

/obj/machinery/computer/shuttle/loneSlaver/recall
	name = "slaver shuttle recall terminal"
	desc = "Use this if your friends left you behind."
	possible_destinations = "lone_slavers_den"

/obj/machinery/computer/camera_advanced/shuttle_docker/loneSlaver
	name = "slaver shuttle navigation computer"
	desc = "Used to designate a precise transit location for the slaver shuttle."
	icon_screen = "syndishuttle"
	icon_keyboard = "syndie_key"
